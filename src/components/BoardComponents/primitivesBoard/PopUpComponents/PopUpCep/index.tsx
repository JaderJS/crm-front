...
const FIND_UNIQUE_PRIMITIVE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPCEP = gql`
  query findUniquePrimitiveFieldInCreateOneFieldInPopUpCEP($type: FieldType!) {
...
const UPSERT_ONE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPCEP = gql`
  mutation upsertOneFieldInCreateOneFieldInPopUpCEP(
    $id: Int!
...
export function PopUpCep({ columnId, typeField, field, uuid, refetch }: IPopUpShortTextProps) {
  ...
  const [primitiveField] = useLazyQuery<PrimitiveField>(
    FIND_UNIQUE_PRIMITIVE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPCEP,
  )
  const [upsertOneField] = useMutation(UPSERT_ONE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPCEP)
