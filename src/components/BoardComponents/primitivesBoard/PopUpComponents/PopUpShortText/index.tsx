...
const FIND_UNIQUE_PRIMITIVE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPSHORTTEXT = gql`
  query findUniquePrimitiveFieldInCreateOneFieldInPopUpShortText($type: FieldType!) {
...
const UPSERT_ONE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPSHORTTEXT = gql`
  mutation upsertOneFieldInCreateOneFieldInPopUpShortText(
    $id: Int!
...
export function PopUpShortText({ columnId, typeField, field, uuid, refetch }: IPopUpShortTextProps) {
  ...
  const [primitiveField] = useLazyQuery<PrimitiveField>(
    FIND_UNIQUE_PRIMITIVE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPSHORTTEXT,
  )
  const [upsertOneField] = useMutation(UPSERT_ONE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPSHORTTEXT)
