...
import { ArrowRight, Clipboard, CloseCircle, DirectInbox, Edit, Link, TextBlock } from "iconsax-react"
...
const FIND_UNIQUE_PRIMITIVE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUP_LINK = gql`
  query findUniquePrimitiveFieldInCreateOneFieldInPopUpLink($type: FieldType!) {
...
const UPSERT_ONE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUP_LINK = gql`
  mutation upsertOneFieldInCreateOneFieldInPopUpLink(
    $id: Int!
...
const fieldType = {
    createLabel: <><Link /> Link</>,
    editLabel: <Edit />,
    type: "LINK"
}

export function PopUpLink({ columnId, field, refetch }: PoPupLinkProps) {
    ...
    const [primitiveField] = useLazyQuery<PrimitiveField>(FIND_UNIQUE_PRIMITIVE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUP_LINK)
    const [upsertOneField] = useMutation(UPSERT_ONE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUP_LINK)
