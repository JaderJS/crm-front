...
const FIND_UNIQUE_PRIMITIVE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPROJECTS = gql`
  query findUniquePrimitiveFieldInCreateOneFieldInPopUpPOPUPROJECTS($type: FieldType!) {
...
const UPSERT_ONE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPROJECTS = gql`
  mutation upsertOneFieldInCreateOneFieldInPopUpPOPUPROJECTS(
    $id: Int!
...
export function PopUpProjects({ columnId, typeField, field, uuid, refetch }: IPopUpShortTextProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      description: "Selecione um ou mais projetos",
      require: false,
    },
  })
  ...
  const [primitiveField] = useLazyQuery<PrimitiveField>(
    FIND_UNIQUE_PRIMITIVE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPROJECTS,
  )
  const [upsertOneField] = useMutation(UPSERT_ONE_FIELD_IN_CREATE_ONE_FIELD_IN_POPUPROJECTS)
